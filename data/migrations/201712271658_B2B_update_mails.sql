					...
					<table width="500" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="480" bgcolor="#FFFFFF" style="font-family:''Lato'', arial, sans-serif; font-size:14px; color:#333;  font-weight:regular; line-height:20px;text-align:justify">
								...
								Gentile %1$s,<br /><br />
								abbiamo dovuto sospendere l&#39;account della sua azienda in quanto uno o pi&ugrave; pagamenti relativi alle corse non sono andati a buon fine. <br /><br />
								Per abilitare nuovamente il profilo aziendale, &egrave; necessario verificare che la carta di credito: <br />
								<ul style="color:#08bd53">
									<li><span style="color:#333;">non sia scaduta;</span></li>
									<li><span style="color:#333;">abilitazione ai pagamenti on line (3d Secure Code);</span></li>
									<li><span style="color:#333;">disponibilit&agrave; di credito.</span></li>
								</ul>
								Per cambiare la carta di credito sul portale Share&#39;ngo, occorre:
								<ul style="color:#08bd53">
				...
				<td>
					...
					<table width="500" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td width="10"></td>
							<td width="480" bgcolor="#FFFFFF" style="font-family:''Lato'', arial, sans-serif; font-size:14px; color:#333;  font-weight:regular; line-height:20px;text-align:justify">
								Ogni volta che salirai a bordo di un&#39;auto Share&#39;ngo, potrai scegliere se usare il PIN aziendale o personale per fatturare il noleggio, rispettivamente sulla carta aziendale o su quella personale.<br /><br />
								Cordiali saluti.<br />
							</td>
							<td width="10"></td>
						</tr>
