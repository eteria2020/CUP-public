...
(nextval('penalties_id_seq'), 'Soccorso stradale perchè il Cliente non avendo osservato il segnale di riserva ha lasciato il veicolo con carica/autonomia inferiore al 10%', 12000),
...
(nextval('penalties_id_seq'), 'Recupero del veicolo fuori dall`area di copertura della città per responsabilità del Cliente', NULL),
