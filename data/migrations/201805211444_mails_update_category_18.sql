INSERT INTO mails (id, subject, content, enable, language, category)
SELECT nextval('mails_id_seq'), subject, content, false, language, 1000018 FROM mails WHERE category=18;

UPDATE mails 
SET content='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                    ...
                    <table border="0" width="600" cellpadding="0" cellspacing="0" class="container" style="width:600px;max-width:600px">
                        <tr>
                            <td class="container-padding content" align="left" style="background-color:#ffffff">
								<img style="width:600px; max-width:100%;" src="http://site.sharengo.it/wp-content/uploads/2018/05/img_mail_scontatore.jpeg" alt="" class="banner"></img>
								<br />
								<div class="body-text" style="padding-left:15px;padding-right:15px;padding-top:5px;padding-bottom:10px;font-family:''Arial'', sans-serif;font-size:14px;line-height:20px;text-align:left;color:#333333">
									Ciao %1$s,<br /><br />
									il tuo sconto personale &egrave; scaduto, ma con Sharengo puoi continuare a correre alla tariffa scontata di <b>0,24&euro;/min</b> a te riservata.<br /><br />
									
									E non finisce qui, scopri come acquistare tutti i nostri Pacchetti Minuti <a href=" https://www.sharengo.it/user/login" style="color:#000;">facendo login</a> e cliccando <b>Promo e Pacchetti</b> in Area Riservata.<br />
									Grazie per aver scelto Sharengo, insieme miglioreremo l&#39;aria e la vita della nostra citt&agrave;. <br /><br />
									
									A presto, la tua Sharengo ti aspetta! <img width="40px" style=" vertical-align: middle;   margin-left: -14px;" src="http://site.sharengo.it/wp-content/uploads/2018/05/cuore_giallo.png" alt=""></img><br /><br />
