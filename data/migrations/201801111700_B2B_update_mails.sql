					...
					<table width="500" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="480" bgcolor="#FFFFFF" style="font-family:''Lato'', arial, sans-serif; font-size:14px; color:#333;  font-weight:regular; line-height:20px;text-align:justify">
								...
								Gentile %1$s,<br /><br />
								il nostro sistema informativo rileva che tra 30 giorni scadr&agrave; la validit&agrave; della carta di credito associata al profilo business della sua azienda. <br /><br />
								Per cambiare la carta di credito basta:<br />
								<ul style="color:#08bd53">
									<li><span style="color:#333;">Effettuare il <a href="http://business.sharengo.it/user/login" target="_blank" style="color:#08bd53; text-decoration:none;">login in</a> sulla Consolle di Gestione del profilo aziendale con Username e Password  <br /> </span></li>
									<li><span style="color:#333;">Cliccare sul pulsante a destra  &quot;<strong>cambia carta</strong>&quot;.</span></li>
									<li><span style="color:#333;">Inserire i dati della nuova carta e confermare</span></li>
								</ul>
								<span style="color:#FF0000;">Attenzione:</span> se non provvederete a rinnovare la carta di credito associata al profilo aziendale <b>Share&#39;ngo</b> il profilo verr&agrave; disattivato (<i>quindi i driver dell&#39;azienda non potranno utilizzare il servizio</i>) fino a quando non sar&agrave; inserita una nuova carta.<br /><br />
					...
					<table width="500" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="480" bgcolor="#FFFFFF" style="font-family:''Lato'', arial, sans-serif; font-size:14px; color:#333;  font-weight:regular; line-height:20px;text-align:justify">
								<span style="font-size:22px; color:#08bd53; font-weight:bold;">SHARE&#39;NGO AZIENDE</span><br /><br />
								Gentile %1$s,<br /><br />
								abbiamo dovuto sospendere l&#39;account della sua azienda in quanto la carta di credito associata al profilo aziendale risulta scaduta.<br /><br />
								Per abilitare nuovamente l&#39;account aziendale &egrave; necessario cambiare la carta di credito. Per farlo basta: <br />
								<ul style="color:#08bd53">
									<li><span style="color:#333;">Effettuare il <a href="http://business.sharengo.it/user/login" target="_blank" style="color:#08bd53; text-decoration:none;">login in</a> sulla Consolle di Gestione del profilo aziendale con Username e Password <br /> </span></li>
									<li><span style="color:#333;">Cliccare a destra sul pulsante &quot;<strong>cambia carta</strong>&quot;.</span></li>
								</ul>

								Una volta cambiata la carta l&#39;account aziendale sar&agrave; riattivato e tutti i driver potranno continuare ad utilizzare le Share&#39;ngo per i loro spostamenti aziendali.<br /><br />
								In caso di dubbi o difficolt&agrave; pu&ograve; scrivere una mail a <a href="mailto:servizioclienti@sharengo.eu" target="_blank" style="color:#08bd53; text-decoration:none;">servizioclienti@sharengo.eu</a>. <br /><br />
								Cordiali saluti.<br />
							</td>
							<td width="10"></td>
