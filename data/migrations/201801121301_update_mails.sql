DELETE FROM mails WHERE id IN (105, 111);

INSERT INTO mails VALUES (105, 'Share''n Go B2B - Azienda disattivata', '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
					...
					<table width="500" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="480" bgcolor="#FFFFFF" style="font-family:''Lato'', arial, sans-serif; font-size:14px; color:#333;  font-weight:regular; line-height:20px;text-align:justify">
								...
								Gentile %1$s,<br /><br />
								abbiamo dovuto disabilitare l&#39;account della sua azienda in quanto uno o pi&ugrave; pagamenti relativi alle corse effettuate non sono andati a buon fine.<br /><br />
								Per abilitare nuovamente l&#39;account aziendale è necessario verificare: <br />
								<ul style="color:#08bd53">
									<li><span style="color:#333;">La data di scadenza della carta di credito </span></li>
									<li><span style="color:#333;">L&#39;abilitazione della carta ai pagamenti on line (3d Secure Code)</span></li>
									<li><span style="color:#333;">La disponibilità di credito</span></li>
								</ul>
								Per cambiare la carta di credito occorre:
								<ul style="color:#08bd53">
									<li><span style="color:#333;">Effettuare il <a href="http://business.sharengo.it/user/login" target="_blank" style="color:#08bd53; text-decoration:none;">login in</a> login in sulla Consolle di Gestione del profilo aziendale con Username e Password<br /> </span></li>
									<li><span style="color:#333;">Cliccare a destra sul pulsante  &quot;<strong>cambia carta</strong>&quot;.</span></li>
								</ul>

								Una volta cambiata la carta, se i pagamenti andranno a buon fine, l&#39;account aziendale sar&agrave; riattivato e tutti i driver potranno continuare ad utilizzare le Share&#39;ngo per i loro spostamenti aziendali.<br /><br />
								In caso di dubbi o difficolt&agrave; pu&ograve; scrivere una mail a  <a href="mailto:servizioclienti@sharengo.eu" target="_blank" style="color:#08bd53; text-decoration:none;">servizioclienti@sharengo.eu</a>. <br /><br />
								Cordiali saluti.<br />
							</td>
							<td width="10"></td>
						</tr>
...
INSERT INTO mails VALUES (111, 'Share''n Go B2B - Abilitazione pin aziendale', '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
					...
					<table width="500" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="480" bgcolor="#FFFFFF" style="font-family:''Lato'', arial, sans-serif; font-size:14px; color:#333;  font-weight:regular; line-height:20px;text-align:justify">
								<span style="font-size:22px; color:#08bd53; font-weight:bold;">SHARE&#39;NGO AZIENDE</span><br /><br />
								Gentile %1$s,<br /><br />
								ti confermiamo l&#39;attivazione del profilo aziendale.<br /><br />
							</td>
							<td width="10"></td>
						</tr>
						<tr>
							<td width="10"></td>
							<td style="font-family:''Lato'', arial, sans-serif; font-size:14px; color:#333;  font-weight:regular; line-height:20px;text-align:center">Il PIN aziendale &egrave; <strong>%2$s</strong><br /><br /></td>
							<td width="10"></td>
						</tr>
						<tr>
							<td width="10"></td>
							<td width="480" bgcolor="#FFFFFF" style="font-family:''Lato'', arial, sans-serif; font-size:14px; color:#333;  font-weight:regular; line-height:20px;text-align:justify">
								Ogni volta che salirai a bordo di un&#39;auto Share&#39;ngo potrai scegliere se usare il <b>PIN aziendale</b> o il <b>PIN personale</b> per fatturare rispettivamente quel noleggio sulla carta aziendale o sulla carta personale.<br /><br />
								Buone prossime corse con Share&#39;ngo!<br /><br />
								Cordiali saluti.<br />
							</td>
							<td width="10"></td>
						</tr>
