...
CREATE TABLE trip_bills (id INT NOT NULL, trip_id INT DEFAULT NULL, minutes INT NOT NULL, cost INT NOT NULL, timestamp_beginning TIMESTAMP(0) WITH TIME ZONE NOT NULL, timestamp_
end TIMESTAMP(0) WITH TIME ZONE NOT NULL, notes TEXT DEFAULT NULL, PRIMARY KEY(id));
