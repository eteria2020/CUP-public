...
INSERT INTO partners (name, code, params, enabled) VALUES ('Nugo', 'nugo', '{"payments" : { "uri" : "https://www.nugo.com", "authorization" : "sharengo_test_key"}, "notifyCustomerStatus" :{ "uri" : "http://www.cert.nugo.com/nugo/api/external/sharengo/charge-account"}, "importInvoice" :{ "uri" : "http://www.cert.nugo.com/nugo/api/external/sharengo/billing"}}', true);
