...
- modified login page to manage the view for apps (hide header and footer)
- fix some CSS for text justified in rents page

## [1.0.63] - 2020-03-10

### Changed

- For Italian server instance, warning message for subscription suspended.

## [1.0.62] - 2020-03-06

### Added

- Removed ExtraData from the BankArt customer (see ticket [871](https://sharengo.freshdesk.com/helpdesk/tickets/871))
- Fix a translation in CustomerBonusPackages
