...
class SignupSI2Fieldset extends Fieldset implements InputFilterProviderInterface {
    ...
    public function __construct(
        ...
        $this->add([
            ...
            'options' => [
                ...
                'value_options' => $this->countriesService->getAllCountries( "Slovenia")
            ]
        ]);
...
//            ],
//            'options' => [
//                'label' => $translator->translate('Luogo di nascita'),
//                'use_hidden_element' => true
//            ]
//        ]);
        ...
        $this->add([
            ...
            'options' => [
                ...
                'value_options' => $countriesService->getAllPhoneCodeByCountry('Slovenia')
            ]
        ]);
